...
object JavaFunctionConnector : FunctionConnector {
    ...
    override fun connect(funInfo: FunctionInfoCollector.FunctionInfoCollection): FunctionConnector.FunctionCollection {
        ...
        return FunctionConnector.FunctionCollection(convertedStatics, convertedInstances)
    }
