...
class DefaultFunctionSignatureInfoBuilder(
    ...
    private fun parseStaticReturnType(value: SignatureParser.ReturnTypeContext): IntStaticCmi? = when (val type = value.javaTypeSignature()) {
        null -> infoRepo.voidType.toIntMinInfo().complete()
    ...
    private fun parseStaticArgs(parseBase: ParseBase, paramNames: List<String>?, implicitThis: IntStaticCmi?): FunSignatureInfo.Direct? {
    ...
    override fun parseGenericSam(paramNames: List<String>?, signature: String, implicitThis: IntMinInfo, implicitThisTps: List<TemplateTypeParamInfo>): FunSignatureInfo.Generic? {
    ...
    override fun parseTemplateFunction(name: String, paramNames: List<String>?, signature: String, implicitThis: IntMinInfo, implicitThisTps: List<TemplateTypeParamInfo>): FunSignatureInfo.Generic {
        val parseBase = parseFunctionBase(signature, implicitThisTps)
    ...
    override fun parseDirectFunction(name: String, paramNames: List<String>?, signature: String, implicitThis: IntMinInfo): FunSignatureInfo<*> {
    ...
    override fun parseDirectConstructor(type: IntMinInfo, signature: String, paramNames: List<String>?): FunSignatureInfo<*> {
        val parseBase = parseFunctionBase(signature, emptyList())
    ...
    override fun parseTemplateConstructor(type: IntMinInfo, typeParams: List<TemplateTypeParamInfo>, signature: String, paramNames: List<String>?): FunSignatureInfo.Generic {
