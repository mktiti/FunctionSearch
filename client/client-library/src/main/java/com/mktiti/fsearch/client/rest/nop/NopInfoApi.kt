...
internal object NopInfoApi : InfoApi {
    ...
    override fun types(context: QueryCtxDto, namePartOpt: String?): ApiCallResult<ResultList<TypeInfoDto>> = nopResult()

    override fun functions(context: QueryCtxDto, namePartOpt: String?): ApiCallResult<ResultList<FunId>> = nopResult()
